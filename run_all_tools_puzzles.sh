...
directory="/home/project/12003580/rnapuzzles"
current_dir=$(pwd)
...
for folder in $(cat "$file"); do
    ...
    qsub -P 12003580 -N $jobname -q normal -l select=1:ncpus=128:mpiprocs=128:mem=300G -l walltime=24:00:00 -o $output -e $error -v work="$directory",target_rna="$folder" /home/project/12003580/run_rf.sh
    ...
    cp $folder.fasta $directory/$folder/df/seq.fasta
    ...
    qsub -P 12003580 -N $jobname -q normal -l select=1:ncpus=64:mpiprocs=64:mem=300G -l walltime=24:00:00 -o $output -e $error -v work="$directory",target_rna="$folder" /home/project/12003580/run_df.sh
    ...
    qsub -P 12003580 -N $jobname -q normal -l select=1:ncpus=64:mpiprocs=64:mem=300G -l walltime=24:00:00 -o $output -e $error -v work="$directory",target_rna="$folder" /home/project/12003580/run_rhofold.sh
    ...
    qsub -P 12003580 -N $jobname -q normal -l select=1:ncpus=64:mpiprocs=64:mem=300G -l walltime=24:00:00 -o $output -e $error -v work="$directory",target_rna="$folder" /home/project/12003580/run_drfold.sh
